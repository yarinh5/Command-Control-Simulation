...
namespace ccsim::domain {
  ...
  struct TelemetryData {
    ...
    TelemetryData(const UnitId& id, const Position& pos, UnitStatus stat)
    ...
    static TelemetryData from_json(const nlohmann::json& j) {
  ...
  public:
    explicit TelemetryReport(const TelemetryData& data) : data_(data) {}
    
    const TelemetryData& data() const { return data_; }
    ...
    static std::unique_ptr<TelemetryReport> from_json(const nlohmann::json& j) {
